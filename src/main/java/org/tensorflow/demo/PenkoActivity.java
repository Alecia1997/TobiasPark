 ...
 */
public class PenkoActivity extends Activity {
    private Button buttonMeet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penko);

        buttonMeet = (Button) findViewById(R.id.buttonMeet);
    ...
    public void start() {
        Intent intent = new Intent(this, MashActivity.class);
